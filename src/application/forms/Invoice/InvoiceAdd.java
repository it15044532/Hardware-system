...
public class InvoiceAdd extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblInvoiceRemove.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Product Name", "Product Type", "Unit Price (Rs.)", "Quantity"
            }
        ));
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panel1Layout.createSequentialGroup()
                                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(panel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(cmbCustomer, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                    ...
                                    .addGroup(panel1Layout.createSequentialGroup()
                                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addGroup(panel1Layout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addComponent(btnCheckout, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                                            .addGroup(panel1Layout.createSequentialGroup()
                                                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
      ...
      if (tblInvoiceRemove.getRowCount() > 0) {
            ...
            if (cmbCustomer.getSelectedItem() instanceof Customer) {
                ...
                if (datePickerCheckout.getDate() != null) {
                    ...
                    invoice.setCustomerRef((Customer) cmbCustomer.getSelectedItem());
                    ...
                    if (status) {
                        JOptionPane.showMessageDialog(this, "Invoice added successfully.", "Success Message", JOptionPane.INFORMATION_MESSAGE);
                        this.dispose();
                       
                    } else {
                        JOptionPane.showMessageDialog(this, "Error in adding Invoice.", "Error Message", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
    ...
    private void cmbCustomerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbCustomerMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbCustomerMouseClicked
